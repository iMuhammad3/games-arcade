...
function Main({selectedGame, setSelectedGame}) {
  ...
  return (
    <main className="bg-slate-50 dark:bg-slate-850 text-midnightblue dark:text-slate-100 flex-grow py-10 px-16 flex flex-col gap-6">
      {!selectedGame && <SearchInput forHeader={false} />}
